...
export default function Box({ children, positionArrow, positionBox }: { children: ReactNode, positionArrow: string, positionBox?: string }) {
    return (
        <div className={`absolute z-50 top-[calc(100%+12px)] left-[50%] -translate-x-[50%] ${positionBox}`}>
